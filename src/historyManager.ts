...
import { ManagerPaths } from './paths.js';
...
export class HistoryManager {
  ...
  async listSummaries(options: { search?: string; limit?: number; onlyPinned?: boolean; hideAgents?: boolean } = {}): Promise<SessionSummary[]> {
  ...
  async copyResumeCommand(sessionId: string): Promise<string> {
